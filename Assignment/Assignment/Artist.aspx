...
<body>
    <form id="form1" runat="server">
        <table class="auto-style2">
            <tr>
                <td colspan="5">Profile:<asp:Label ID="lblUsernameText" runat="server" Text="You LogIn As: "></asp:Label>
                    <asp:Label ID="lblUsername" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="5">Profile Picture:</td>
            </tr>
            <tr>
                <td colspan="5">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:Button ID="btnUpload" runat="server" CssClass="auto-style7" OnClick="btnUpload_Click" Text="Upload" />
                </td>
            </tr>
            <tr>
