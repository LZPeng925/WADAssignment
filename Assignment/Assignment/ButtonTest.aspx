...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            ID:
            <asp:DropDownList ID="ddlInventoryID" runat="server" DataSourceID="SqlDataSource1" DataTextField="id" DataValueField="id">
            </asp:DropDownList>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="btnHistory" runat="server" Text="Pay history" Width="182px" PostBackUrl="~/PaymentHistory.aspx" />
            <br />
            <br />
