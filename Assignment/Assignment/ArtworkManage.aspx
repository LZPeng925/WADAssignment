<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArtworkManage.aspx.cs" Inherits="Assignment.ArtworkManage" %>
...
<body style="height: 760px; margin-top: 27px; width: 731px;">
    ...
    <form id="form1" runat="server" class="auto-style5">
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    ...
                    <br />
                    <asp:Button ID="btnManageUpload" runat="server" Text="Upload" BackColor="#006666" Font-Bold="True" ForeColor="White" />
                </td>
            </tr>
            <tr>
        ...
        &nbsp;&nbsp;&nbsp;
             <asp:Button ID="Button1" runat="server" Text="Submit" Height="33px" Width="87px" BackColor="#006666" Font-Bold="True" ForeColor="White" />
