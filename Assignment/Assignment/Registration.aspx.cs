    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void radUserType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (radUserType.SelectedItem.ToString() == "Artist")
            {
                ...
                RequiredFieldValidator14.ControlToValidate = "ddlBank";
                RequiredFieldValidator15.Visible = true;
                RequiredFieldValidator15.ControlToValidate = "txtBankAcc";
            }
            else
            {
                lblBank.Visible = false;
                ...
                txtBankAcc.Visible = false;
                RequiredFieldValidator14.Visible = false;
                RequiredFieldValidator14.ControlToValidate = "";
                RequiredFieldValidator15.Visible = false;
                RequiredFieldValidator15.ControlToValidate = "";
            }
        }
    }
}