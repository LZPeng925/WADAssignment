            ...
            <table style="width:100%;">
                <tr>
                    <td style="text-align:center" class="auto-style2" colspan="2"><h1>View Cart</h1>
                        <asp:DataList ID="DataList1" runat="server" DataKeyField="cartID" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" Width="100%" OnItemCommand="DataList1_ItemCommand">
                            <ItemTemplate>
                                Cart ID:
...
<%--                        <asp:DataList ID="DataList2" runat="server" DataKeyField="cartID" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" Width="100%" OnItemCommand="DataList1_ItemCommand">
                            <ItemTemplate>
                                Cart ID:
                                <asp:Label ID="cartIDLabel" runat="server" Text='<%# Eval("cartID") %>' />
                                <br />
